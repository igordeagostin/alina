...
public sealed class PoliticaPermissaoTests : IDisposable
{
    ...
    {
        PoliticaPermissao pol = new PoliticaPermissao(_arquivo);
    ...
    public void Aprender_sempre_cria_regra_por_prefixo_de_comando_e_persiste()
    {
        ...
        PoliticaPermissao recarregada = new PoliticaPermissao(_arquivo);
    ...
    {
        string raiz = OperatingSystem.IsWindows() ? @"C:\proj" : "/proj";
        PoliticaPermissao pol = new PoliticaPermissao(_arquivo);
        ...
        string outro = OperatingSystem.IsWindows() ? @"C:\outro" : "/outro";
